...
const Blogs = () => {
    ...
    return (
        <>
            <Navbar></Navbar>
            <button className='flex items-center border m-1 px-1 rounded text-white bg-sky-600 hover:bg-sky-700' onClick={exportPDF}><BsDownload className='inline mr-1' /> Download</button>
